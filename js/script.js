	...
	*/
	...
	$(document).ready(function () {
		$(".certificate-link").mouseover(function () {
			var certificateName = $(this).data("certificate");
			var certificateSrc = "Images/Cert/" + certificateName + ".jpg"; // Update the path to your certificate images
			$("#certificate-img").attr("src", certificateSrc);
			$("#certificate-popup").css("display", "flex");
		});

		$(".certificate-link").mouseout(function () {
			$("#certificate-popup").css("display", "none");
		});
